...
fn handle_redeem_plus_cancel_case() -> bool {
    ...
    validate_output_exit_if_false(0, VRF, 2);
    validate_output_exit_if_false(1, YES, 2);
    validate_output_exit_if_false(2, NO, 2);
    validate_output_exit_if_false(3, TTD, 2);
    validate_output_exit_if_false(4, YES, 0);
    validate_output_exit_if_false(5, NO, 0);
    validate_output_exit_if_false(6, TTD, 0);
    validate_output_exit_if_false(7, TTD, 0);
    validate_output_exit_if_false(8, BASE_ASSET, 2);
...
fn handle_redeem_case() -> bool {
    ...
    validate_output_exit_if_false(0, VRF, 2);
    validate_output_exit_if_false(2, TTD, 2);
    validate_output_exit_if_false(4, TTD, 0);
    validate_output_exit_if_false(6,BASE_ASSET,2);

    return 
    // OUTPUT VALIDATIONS
    (validate_output(1, YES, 2) || validate_output(1, NO, 2))
    && (validate_output(3, YES, 0) || validate_output(3, NO, 0))    
    // OUTPUT TO VALIDATIONS
...
fn handle_cancellation_case() -> bool {
    ...
    validate_output_exit_if_false(0, VRF, 2);
    validate_output_exit_if_false(1, TTD, 2);
    validate_output_exit_if_false(2, YES, 2);
    validate_output_exit_if_false(3, NO, 2);
    validate_output_exit_if_false(4, TTD, 0);
    validate_output_exit_if_false(5, YES, 0);
    validate_output_exit_if_false(6, NO, 0);
    validate_output_exit_if_false(7, BASE_ASSET, 2);
...
fn handle_order_matching_case(order_predicate:Address) -> bool {
    ...
    validate_output_exit_if_false(0, VRF, 2);
    validate_output_exit_if_false(1, NO, 2);
    validate_output_exit_if_false(2, YES, 2);
    validate_output_exit_if_false(3, YES, 0);
    validate_output_exit_if_false(4, NO, 0);
    validate_output_exit_if_false(5, BASE_ASSET, 2);
...
fn validate_output_exit_if_false(index: u64, expected_asset_id: AssetId, expected_asset_type: u64) -> bool {
   let res = validate_output(index, expected_asset_id, expected_asset_type);
   if res {
      __contract_ret(&res, __size_of::<bool>());
   }
   true
}
